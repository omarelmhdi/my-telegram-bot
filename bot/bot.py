...
import openai
from pymongo import MongoClient  # إضافة مكتبة MongoDB
...
if config.mongodb_uri:
    ...
    db = None  # أو تجاهل تخزين أي بيانات
...
def run_bot() -> None:
    ...
    # add handlers
    # إزالة القيود على المستخدمين المسموح لهم
    user_filter = filters.ALL  # السماح لجميع المستخدمين
